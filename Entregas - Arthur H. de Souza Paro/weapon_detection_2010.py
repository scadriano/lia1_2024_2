...
model = YOLO('model/weapondetectionbest.pt')

# Abre o vídeo para processamento
video = cv2.VideoCapture('videos/WhatsApp Video 2024-10-21 at 10.06.21.mp4')
...
while True:
    ...
    for obj in results:
        ...
        for item in obj.boxes:
            ...
            if nomeClasse == 'shooter' or nomeClasse == 'gun' or nomeClasse == 'knife':
